(function(a, b) {
  ...
  var a = a || (function(f, h) {
    ...
    var g = c.Hasher = j.extend({
      cfg: l.extend(), init: function(p) {
        ...
        return q;
      }, blockSize: 512 / 32, _createHelper: function(p) {
        return function(r, q) {
  ...
  (function() {
    ...
    var h = f.PBKDF2 = c.extend({
      cfg: c.extend({ keySize: 128 / 32, hasher: d, iterations: 1 }), init: function(j) {
  ...
  (function() {
    ...
    var b = f.EvpKDF = c.extend({
      cfg: c.extend({ keySize: 128 / 32, hasher: d, iterations: 1 }), init: function(i) {
  ...
  (function() {
    ...
    var b = e.RC4Drop = d.extend({
      cfg: d.cfg.extend({ drop: 192 }), _doReset: function() {
